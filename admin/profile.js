    ...
    //   mot phien ban err Chat  messeages
        ...
        myDataRef.on('child_added', function (snapshot){
            ...
            snapshot.forEach(function(childSnapshot) {
                ...
                // var n = snapshot.child("image").val(Object.keys(arr));

                // imagefile +=
                //     '                                                <div class="col-lg-1">\n' +
                //     '                                                    <div class="grid-container">\n' +
                //     '                            <img src=" '+n+'" class="user-avartar">\n' +
                //     '                                                    </div>\n' +
                //     '                                                </div>\n' ;
                // console.log(imagefile);
                // $('<div/>').prepend(imagefile).appendTo($("#show-model"));
            });
...
function showViewMessage(userID) {
    ...
    function Viewallmessage(name,text,image,time,id) {
        ...
        if(id){
            console.log('left');
            console.log($('<div/>').prepend(messages).appendTo($(".list-messages"))
            );
        ...
        //     '                                               <span class="float-left m-2 mr-4"><img src=" '+image+'" style="height: 100px;" alt="" class="rounded-circle img-thumbnail"></span>' +
        //     '                                                <div class="media-body">\n' +
        //     '\n' +
        ...
        //     '                                                            <p class="mb-0 font-13 text-white-50">'+text+'</p>\n' +
        //     '                                                            <p class="mb-0 font-13 text-white-50">'+time+'</p>\n' +
        //
        //     '                                                        </li>\n' +
        //     '                                                    </ul>\n' +
        //     '                                                </div> <!-- end media-body-->\n' +
        //     '                                            </div>';
        // $('.messages-views-user').html(messages);
    }
}
